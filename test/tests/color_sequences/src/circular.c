...
void test_circular_case1(void) {
  ...
  if (TEST_PROTECT()) {
    ...
    for (size_t idu = 1; idu < width - 1; idu++) {
      ...
      ret = color_sequence_get_color_continuous_circular(color_sequence, phase, &color);
...
void test_circular_case3(void) {
  ...
  if (TEST_PROTECT()) {
    ...
    TEST_ASSERT_NOT_NULL_MESSAGE(img, "could not create img png");
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(ref, TEST_OUTPUT_DIR "/circular_case3_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(img, TEST_OUTPUT_DIR "/circular_case3_img.png"));
...
void test_circular_case4(void) {
  ...
  if (TEST_PROTECT()) {
    ...
    TEST_ASSERT_NOT_NULL_MESSAGE(img, "could not create img png");
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(ref, TEST_OUTPUT_DIR "/circular_case4_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(img, TEST_OUTPUT_DIR "/circular_case4_img.png"));
