...
void test_generic_full_display_pixel(void) {
  uext_t width = 3;
  uext_t height = 3;
  ...
  if (TEST_PROTECT()) {
    ...
    // draw a pixel
    int ret =
        simultaneous_generic_pixel(reference, interface, color_sequence, 1, 1);
...
void test_generic_full_display_hline(void) {
  uext_t width = 30;
  uext_t height = 3;
  ...
  if (TEST_PROTECT()) {
    ...
    // draw a hline
    int ret = simultaneous_generic_hline(
    ...
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(
               ref, TEST_OUTPUT_DIR "/generic_full_display_hline_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(
               img, TEST_OUTPUT_DIR "/generic_full_display_hline_img.png"));
...
void test_generic_full_display_vline(void) {
  uext_t width = 3;
  uext_t height = 30;
  ...
  if (TEST_PROTECT()) {
    ...
    // draw a vline
    int ret = simultaneous_generic_vline(
    ...
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(
               ref, TEST_OUTPUT_DIR "/generic_full_display_vline_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(
               img, TEST_OUTPUT_DIR "/generic_full_display_vline_img.png"));
...
void test_generic_full_display_region(void) {
  uext_t width = 30;
  uext_t height = 30;
  ...
  if (TEST_PROTECT()) {
    ...
    // draw a pixel
    int ret = simultaneous_generic_region(
    ...
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(
               ref, TEST_OUTPUT_DIR "/generic_full_display_region_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(
               img, TEST_OUTPUT_DIR "/generic_full_display_region_img.png"));
