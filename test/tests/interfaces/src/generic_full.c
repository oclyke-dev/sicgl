...
void test_generic_full_pixel(void) {
  ...
  if (TEST_PROTECT()) {
    ...
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(ref, TEST_OUTPUT_DIR "/generic_full_pixel_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(img, TEST_OUTPUT_DIR "/generic_full_pixel_img.png"));
...
void test_generic_full_hline(void) {
  ...
  if (TEST_PROTECT()) {
    ...
    TEST_ASSERT_NOT_NULL_MESSAGE(img, "could not create img png");
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(ref, TEST_OUTPUT_DIR "/generic_full_hline_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(img, TEST_OUTPUT_DIR "/generic_full_hline_img.png"));
...
void test_generic_full_vline(void) {
  ...
  if (TEST_PROTECT()) {
    ...
    TEST_ASSERT_NOT_NULL_MESSAGE(img, "could not create img png");
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(ref, TEST_OUTPUT_DIR "/generic_full_vline_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(img, TEST_OUTPUT_DIR "/generic_full_vline_img.png"));
...
void test_generic_full_region(void) {
  ...
  if (TEST_PROTECT()) {
    ...
    TEST_ASSERT_NOT_NULL_MESSAGE(img, "could not create img png");
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(ref, TEST_OUTPUT_DIR "/generic_full_region_ref.png"));
    TEST_ASSERT_EQUAL_INT(
        0, png_to_file(img, TEST_OUTPUT_DIR "/generic_full_region_img.png"));
